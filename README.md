...
## Prerequisites
To use these dotfiles on your local system, ensure you have [git](https://wiki.archlinux.org/title/git) and [GNU stow](https://archlinux.org/packages/extra/any/stow/) installed

`sudo pacman -S git stow` 

## Installation
1) Clone the library into $HOME: `git clone https://github.com/FlamemasterNXF/dotfiles`
